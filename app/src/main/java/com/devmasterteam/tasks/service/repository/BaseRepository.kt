...
open class BaseRepository(val context: Context) {
    ...
    fun isConnectionAvailable(): Boolean {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            // As funçoes sublinhadas abaixo quer dizer que estão deprecated, porém, como aqui é um else
            // Só vai entrar nesta parte do código caso a versãodo Android seja menor que 23
